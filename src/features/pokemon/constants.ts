...
export type TypeResistance = {
  readonly weakness: ReadonlyArray<PokemonType>;
  readonly resistance: ReadonlyArray<PokemonType>;
  readonly immunity: ReadonlyArray<PokemonType>;
};

export type TypeMatrix = {
  readonly [K in PokemonType]: TypeResistance
};
